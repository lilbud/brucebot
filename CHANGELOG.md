...
- 2024-09-15 - fix setlist notes, change the number to a ROW_NUMBER() instead of the view generated num. Which for reasons unknown will never be in the correct order (num greater than number of notes, wrong number entirely, etc.)
